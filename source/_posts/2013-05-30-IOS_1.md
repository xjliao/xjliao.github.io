...
---
##demo1
>代码创建,无nib，xib，storyboard文件，纯代码 
...
##demo2
>代码创建,新建的空项目，有一个xib，viewController手动关联xib文件，和关联操作xib文件现有拖进去的控件，在xib文件上手写代码加入控件。xib文件名为xjlViewController.xib,其实应该大写的，一时糊涂，暂不改了  
